...
public class ChatUtils {
    ...
    private final UUID APP_UUID = UUID.fromString("2d0e4ec6-a0e5-46e4-acdf-79f40e3d9077");
    ...
    public synchronized void setState(int state) {
        this.state = state;
        handler.obtainMessage(Integer.parseInt(MainActivity.MESSAGE_STATE_CHANGE), state, -1).sendToTarget();
    }
